...
insert into initiatives
  (id, title, summary, expected_outcome, status, owner_id, team, theme_id, strategic_goal,
   impact, effort, strategic_fit, urgency, confidence, target_start, target_end, visibility, notes)
values
  ('i-pbx', 'PBX predictive targeting v2',
   ...
   'in_progress', 'u-magali', 'AI & Personalization', 't-ai', 'Lead the market on AI-driven experimentation',
   5, 4, 5, 4, 'medium', '2026-04-01', '2026-09-30', 'external',
  ...
  ('i-flicker', 'Zero-flicker rendering engine',
   ...
   'in_progress', 'u-helene', 'Web Experimentation', 't-web', 'Best-in-class web testing experience',
   5, 3, 4, 5, 'high', '2026-05-01', '2026-08-15', 'external', 'Perf budget agreed with SDK team.'),
  ('i-stats', 'Bayesian stats engine GA',
   ...
   'at_risk', 'u-nadia', 'Data & Analytics', 't-trust', 'Results people can trust',
   4, 5, 5, 3, 'low', '2026-03-01', '2026-07-31', 'internal', 'Validation dataset behind schedule.');
